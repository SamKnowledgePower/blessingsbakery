const months=[
  ...
  {id:4,title:'不敗課程會員化',focus:'接續盤點並再製不敗的酸麵包製作',tasks:['集中拍攝工作日 04','不敗的酸麵包製作翻拍 01','公開旗艦長片 04','短影音第 13–16 支','社群圖文第 13–16 則','SEO 文稿 02','會員直播協作 04','Sourdough Taiwan 實體體驗 02','會員觀看／提問／續訂觀察']},
  {id:5,title:'書籍名單與轉換優化',focus:'優化 LINE 綁定、影片解鎖與會員 CTA',tasks:['集中拍攝工作日 05','不敗的酸麵包製作翻拍 02','公開旗艦長片 05','短影音第 17–20 支','社群圖文第 17–20 則','會員直播協作 05','Sourdough Taiwan 線上體驗 03','書籍讀者解鎖與付費會員轉換檢核']},
  ...
  {id:7,title:'首批理念夥伴培育',focus:'從體驗與會員中篩選社區型烘焙坊',tasks:['集中拍攝工作日 07','兩門現有課程剩餘內容依盤點再製','公開旗艦長片 07','短影音第 25–28 支','社群圖文第 25–28 則','會員直播協作 07','Sourdough Taiwan 線上體驗 04','夥伴理念／場地／設備初步盤點']},
  ...
  {id:9,title:'產品解鎖與年度規範',focus:'建立黑麥／布里歐與年度審核條件',tasks:['集中拍攝工作日 09','兩門現有課程剩餘內容依盤點再製','公開旗艦長片 09','短影音第 33–36 支','社群圖文第 33–36 則','會員直播協作 09','Sourdough Taiwan 線上體驗 05','黑麥／布里歐解鎖條件草案','年度審核規範草案']},
  ...
  {id:12,title:'全年交付與下一年度擴張',focus:'完成移交、年度審核與 10 家目標檢核',tasks:['集中拍攝工作日 12','公開旗艦長片 12','短影音第 45–48 支','社群圖文第 45–48 則','SEO 文稿 06','會員直播協作 12','Sourdough Taiwan 實體體驗 06','幸福烘焙與不敗課程再製完成度結算','正式成品與執行紀錄移交','首年 10 家社區型烘焙坊目標檢核']}
];
const metrics=[['短影音',0,48],['社群圖文',0,48],['旗艦長片',0,12],['SEO 文稿',0,6],['會員直播協作',0,12],['Sourdough 體驗',0,12],['現有課程再製',0,2],['拍攝工作日',0,12]];
